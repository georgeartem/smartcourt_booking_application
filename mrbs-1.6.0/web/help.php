...
echo "<h3>" . get_vocab("About SMART COURT RESERVATIONS") . "</h3>\n";
echo "<table id=\"version_info\">\n";
echo "<tr><td><a href=\"http://www.mysmartcourt.com\"> SMART COURT RESERVATIONS</a>:</td><td>" . get_mrbs_version() . "</td></tr>\n";
